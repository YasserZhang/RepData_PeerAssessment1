...
I found there is no significant difference between the mean total number of steps taken per day,`r mean_per_day`, and its median, `r median_per_day`. So there is little skewness in the distribution of total number od steps taken per day across the two months.
